...
├── master_thesis_python_repo             # The main python package for the project
...
e.g: `cat master_thesis_python_repo/VERSION` will get the project version without harming
